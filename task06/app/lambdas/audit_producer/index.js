...
exports.handler = async (event) => {
    ...
    if (eventDetail.eventName === 'INSERT') {
        content['newValue'] = {
            ...
            value: eventDetail.dynamodb.NewImage.value.N
        };
    } 
    if (eventDetail.eventName === 'MODIFY') {
        content['oldValue'] = eventDetail.dynamodb.OldImage.value.N; 
        content['newValue'] = eventDetail.dynamodb.NewImage.value.N;
    }
